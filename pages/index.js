...
class IndexPage extends React.Component {
    ...
    render() {
        ...
        const heartbeatReason = heartbeating
            ? "App is on-line"
            : "App is off-line";
       const salesforceStreamIsUp = this.state.status
            .salesforceStreamingConnectionIsUp;
        const salesforceStreamReason = this.state.status
            .salesforceStreamingConnectionReason;
        const salesforceReason = heartbeating
            ? salesforceStreamReason
            : heartbeatReason;
                        ...
                        <span
                            className={classNames({
                                ...
                                "salesforce-stream-online":
                                    heartbeating && salesforceStreamIsUp
                            })}
                            title={salesforceReason}
                        >
                            {"☁️"}
                        </span>
                    </h1>
